...
author:   
  ...
  - name: "**Content Editors: Bin Li, Sarah Weinstein, Steven Martinez**"
date: "2024-07-31"
output:
  html_document:
    toc: true
...
#If you haven't installed the "NEST" package before this workshop, run this command first: install.packages("NEST")library(parallel)
