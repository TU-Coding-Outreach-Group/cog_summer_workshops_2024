...
author:   
  - name: "**Content Creator: Bin Li, Dr. Sarah Weinstein**"
  - name: "**Content Editors: Bin Li, Dr. Sarah Weinstein, Steven Martinez**"
date: "2024-07-31"
output:
  html_document:
    toc: true
...
#If you haven't installed the "rstudioapi" package before this workshop, run this command first: install.packages("rstudioapi")
...
```{r}
#If you haven't installed the "parallel" package before this workshop, run this command first: install.packages("parallel")
#If you haven't installed the "NEST" package before this workshop, run this command first: install.packages("NEST")
...
Network partition labels can be found [here](https://github.com/ThomasYeoLab/CBIG/tree/master/stable_projects/brain_parcellation/Schaefer2018_LocalGlobal/Parcellations/HCP/fslr32k/cifti).
...
```{r, echo=FALSE, out.width='80%', fig.align='center', fig.cap='Behavioral data can be downloaded [here](https://db.humanconnectome.org/data/projects/HCP_1200).​​'}
knitr::include_graphics("imgs/brain-imaging.png")
```
...
wb_path <- "/Users/tuh20985/Desktop/workbench/bin_macosxub" # specify your own path

ciftiTools.setOption("wb_path", wb_path)

cifti <- read_cifti("/Users/tuh20985/Desktop/workbench/data/Q1-Q6_R440.All.sulc.32k_fs_LR.dscalar.nii")
...
behavior <- read.csv("/Users/tuh20985/Desktop/workbench/data/unrestricted_steventmartinez_7_29_2024_15_2_18.csv", row.names="Subject") # specify your own path


#If you haven't installed the "string" package before this workshop, run this command first: install.packages("stringr")
#If you haven't installed the "tibble" package before this workshop, run this command first: install.packages("tibble")
library(stringr)
library(tibble)
...
```{r}
net_data <- read_cifti("/Users/tuh20985/Desktop/workbench/data/Schaefer2018_1000Parcels_7Networks_order.dlabel.nii") # specify your own path
# names(net$data)
...
We need to map from Schaefer2018 1000 parcels to yeo2011 7 networks. [*](https://github.com/ThomasYeoLab/CBIG/blob/master/stable_projects/brain_parcellation/Yeo2011_fcMRI_clustering/1000subjects_reference/Yeo_JNeurophysiol11_SplitLabels/Yeo2011_7networks_N1000.split_components.glossary.csv)
```{r}
