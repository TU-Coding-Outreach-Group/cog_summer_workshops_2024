...
## Inspect Data
The dataset contains 4 variables: $id$, $year$ (years using fentanyl), $sex$ (female = 0, male = 1), and $log\_elasticity$ (how sensitive consumption/demand is to changes in price). These data are already formatted for our purposes, but it is worth inspecting the data.
```{r}
# QUICK PEAK
head(demand_data)
