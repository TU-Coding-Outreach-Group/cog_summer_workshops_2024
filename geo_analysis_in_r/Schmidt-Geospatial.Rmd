...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/ihF72Ax9Ol4")
```
...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/c3rF5XvOw3s")
```
...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/b3Z1EOvbmmI")
```
...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/cbIS_nqWGuU")
```
...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/hXaom17VRX0")
```
...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/lZ8my7HCBl8")
```
...
```{r, echo=FALSE}
vembedr::embed_url("https://youtu.be/8bHgnzgUH6M")
```
